var quizdata = [
  ...
  { question: "The longest side of a rectangular house is 25m. If you walk around the house within close proximity you walk 74m. What is the approximate length of the shortest side of the house?", options: ["12m", "25m", "10m", "24m"], answer: "12m", category: 1 },
...
{ 
  ...
  { question: "How many metropolitan municipalities (major metropolitan cities) are there in South Africa?", options: ["5", "8", "11", "6"], answer: "8", category: 2 },
  { question: "What is the national flower of South Africa?", options: ["King Protea", "Bird of Paradise", "Arum Lily", "Aloe"], answer: "King Protea", category: 2 },
  { question: "In what year was the South African men's national football team, Bafana Bafana, officially founded?", options: ["1992", "1994", "1988", "1996"], answer: "1992", category: 2 },

  // --- CATEGORY 3: Pop Culture (10 Questions) ---
  { question: "What is the greatest manga/anime of all time?", options: ["Naruto", "Attack on Titan", "One Piece", "Bleach"], answer: "One Piece", category: 3 },
  ...
  { question: "What year did Michael Jackson's album 'Thriller' come out?", options: ["1980", "1982", "1985", "1988"], answer: "1982", category: 3 },
  { question: "Who plays Iron Man (Tony Stark) in the MCU?", options: ["Robert Downey Jr.", "Chris Evans", "Mark Ruffalo", "Chris Hemsworth"], answer: "Robert Downey Jr.", category: 3 },
  ...
  { question: "Which movie won the Academy Award for Best Picture in 2024?", options: ["Oppenheimer", "Barbie", "Poor Things", "The Holdovers"], answer: "Oppenheimer", category: 3 },
  ...
  { question: "What is the name of the fictional continent where the main events of Game of Thrones take place?", options: ["Westeros", "Essos", "Tamriel", "Middle-earth"], answer: "Westeros", category: 3 },
  ...
  { question: "Approximately how many kilometers long is the Comrades Marathon?", options: ["42 km", "89 km", "56 km", "100 km"], answer: "89 km", category: 4 },
  { question: "What does the word 'Hippopotamus' mean in ancient Greek?", options: ["River horse", "Water monster", "Heavy giant", "Armored pig"], answer: "River horse", category: 4 },
  ...
  { question: "What is the approximate mass of the Earth?", options: ["5.97 x 10^24 kg", "7.34 x 10^22 kg", "1.98 x 10^30 kg", "3.84 x 10^18 kg"], answer: "5.97 x 10^24 kg", category: 4 },
  ...
  { question: "How many psalms are there in a standard biblical Book of Psalms?", options: ["100", "150", "119", "200"], answer: "150", category: 4 },
  ...
  { question: "What is the mathematical formula for the Pythagorean theorem?", options: ["E = mc^2", "a^2 + b^2 = c^2", "A = πr^2", "y = mx + c"], answer: "a^2 + b^2 = c^2", category: 4 },
